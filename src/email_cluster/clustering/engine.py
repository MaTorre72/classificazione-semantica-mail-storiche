...
ITALIAN_STOPWORDS = {
    ...
    "agli", "ai", "dal", "dall", "dalla", "dalle", "degli", "dell", "dello", "gli",
    "nel", "nella", "nelle", "questi", "sul", "sulla", "tutti",
    ...
    "questo", "tel", "via",
    "associate", "contained", "cubesuite", "curriculum", "dati", "herein", "information",
    "informazioni", "martina", "only", "person", "privacy", "recipient", "register",
    "torresendi",
    "download", "leggi", "not", "web",
    "andrea", "ciao", "marco",
}
